package com.sparkTutorial._2_pairRdd.aggregation.reducebykey.housePrice;
...
public class AverageHousePriceSolution {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SparkConf conf = new SparkConf().setAppName("averageHousePriceSolution").setMaster("local[*]");
